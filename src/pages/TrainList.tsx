                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <Checkbox id="morning" />
                      <label htmlFor="morning" className="ml-2 text-sm">Morning (6:00 - 12:00)</label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox id="afternoon" />
                      <label htmlFor="afternoon" className="ml-2 text-sm">Afternoon (12:00 - 18:00)</label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox id="evening" />
                      <label htmlFor="evening" className="ml-2 text-sm">Evening (18:00 - 00:00)</label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox id="night" />
                      <label htmlFor="night" className="ml-2 text-sm">Night (00:00 - 6:00)</label>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <Checkbox id="1a" />
                      <label htmlFor="1a" className="ml-2 text-sm">AC First Class (1A)</label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox id="2a" />
                      <label htmlFor="2a" className="ml-2 text-sm">AC 2 Tier (2A)</label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox id="3a" />
                      <label htmlFor="3a" className="ml-2 text-sm">AC 3 Tier (3A)</label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox id="sl" />
                      <label htmlFor="sl" className="ml-2 text-sm">Sleeper (SL)</label>
                    </div>
                  </div>
                </div>
                <div>
                  <Label className="mb-2 block">Train Type</Label>
                  <div className="space-y-2">
                    <div className="flex items-center">
                      <Checkbox id="rajdhani" />
                      <label htmlFor="rajdhani" className="ml-2 text-sm">Rajdhani</label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox id="shatabdi" />
                      <label htmlFor="shatabdi" className="ml-2 text-sm">Shatabdi</label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox id="duronto" />
                      <label htmlFor="duronto" className="ml-2 text-sm">Duronto</label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox id="superfast" />
                      <label htmlFor="superfast" className="ml-2 text-sm">Superfast</label>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center">
                      <Checkbox id="rac" />
                      <label htmlFor="rac" className="ml-2 text-sm">RAC</label>
                    </div>
                    <div className="flex items-center">
                      <Checkbox id="waitlist" />
                      <label htmlFor="waitlist" className="ml-2 text-sm">WL</label>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <Card.Content className="p-0">
                <div className="p-4 border-b border-gray-100 flex justify-between items-center">
                  <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                    ...
                    <div className="text-xs bg-gray-100 px-2 py-1 rounded-full">{train.days}</div>
                  </div>
                  <div>
                    <Button 
                      variant="ghost" 
                      ...
                      className={cn(
                        "text-sm",
                        selectedTrains.includes(train.id) ? "text-irctc-royal-blue" : "text-irctc-medium-gray"
                      )}
                    >
                ...
                <div className="p-4">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100 flex flex-col md:flex-row justify-between items-start md:items-center">
                    ...
                    <Button 
                      className="bg-irctc-royal-blue hover:bg-irctc-royal-blue/90"
